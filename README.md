...
Disclaimer: This was basically entirely generated by AI and only edited by me when things broke.
            It also should not be trusted iwth anything other than simple items as my testing has been 
            running it once and seeing that it dodn't throw an error. I'm aware that the median price for anything
